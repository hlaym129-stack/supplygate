...
// SetSupplierProfileID sets the "supplier_profile" edge to the SupplierProfile entity by ID.
func (_u *UserUpdate) SetSupplierProfileID(id int64) *UserUpdate {
	_u.mutation.SetSupplierProfileID(id)
	return _u
}

// SetNillableSupplierProfileID sets the "supplier_profile" edge to the SupplierProfile entity by ID if the given value is not nil.
func (_u *UserUpdate) SetNillableSupplierProfileID(id *int64) *UserUpdate {
	if id != nil {
		_u = _u.SetSupplierProfileID(*id)
	}
	return _u
}

// SetSupplierProfile sets the "supplier_profile" edge to the SupplierProfile entity.
func (_u *UserUpdate) SetSupplierProfile(v *SupplierProfile) *UserUpdate {
...
func (_u *UserUpdate) ClearSupplierProfile() *UserUpdate {
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SupplierProfileCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.SupplierProfileTable,
			Columns: []string{user.SupplierProfileColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetSupplierProfileID sets the "supplier_profile" edge to the SupplierProfile entity by ID.
func (_u *UserUpdateOne) SetSupplierProfileID(id int64) *UserUpdateOne {
	_u.mutation.SetSupplierProfileID(id)
	return _u
}

// SetNillableSupplierProfileID sets the "supplier_profile" edge to the SupplierProfile entity by ID if the given value is not nil.
func (_u *UserUpdateOne) SetNillableSupplierProfileID(id *int64) *UserUpdateOne {
	if id != nil {
		_u = _u.SetSupplierProfileID(*id)
	}
	return _u
...
// SetSupplierProfile sets the "supplier_profile" edge to the SupplierProfile entity.
func (_u *UserUpdateOne) SetSupplierProfile(v *SupplierProfile) *UserUpdateOne {
	return _u.SetSupplierProfileID(v.ID)
}
...
// ClearSupplierProfile clears the "supplier_profile" edge to the SupplierProfile entity.
func (_u *UserUpdateOne) ClearSupplierProfile() *UserUpdateOne {
	_u.mutation.ClearSupplierProfile()
	return _u
}
