...
func (_u *UsageLogUpdate) SetAccountOwnerType(v string) *UsageLogUpdate {
	_u.mutation.SetAccountOwnerType(v)
	return _u
}

// SetNillableAccountOwnerType sets the "account_owner_type" field if the given value is not nil.
func (_u *UsageLogUpdate) SetNillableAccountOwnerType(v *string) *UsageLogUpdate {
	if v != nil {
		_u.SetAccountOwnerType(*v)
	}
	return _u
}
...
func (_u *UsageLogUpdate) SetSupplier(v *SupplierProfile) *UsageLogUpdate {
...
func (_u *UsageLogUpdate) ClearSupplier() *UsageLogUpdate {
...
func (_u *UsageLogUpdate) check() error {
	if v, ok := _u.mutation.AccountOwnerType(); ok {
...
func (_u *UsageLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AccountOwnerType(); ok {
...
// SetAccountOwnerType sets the "account_owner_type" field.
func (_u *UsageLogUpdateOne) SetAccountOwnerType(v string) *UsageLogUpdateOne {
	_u.mutation.SetAccountOwnerType(v)
	return _u
}

// SetNillableAccountOwnerType sets the "account_owner_type" field if the given value is not nil.
func (_u *UsageLogUpdateOne) SetNillableAccountOwnerType(v *string) *UsageLogUpdateOne {
	if v != nil {
		_u.SetAccountOwnerType(*v)
	}
	return _u
...
// SetSupplier sets the "supplier" edge to the SupplierProfile entity.
func (_u *UsageLogUpdateOne) SetSupplier(v *SupplierProfile) *UsageLogUpdateOne {
	return _u.SetSupplierID(v.ID)
}
...
// ClearSupplier clears the "supplier" edge to the SupplierProfile entity.
func (_u *UsageLogUpdateOne) ClearSupplier() *UsageLogUpdateOne {
	_u.mutation.ClearSupplier()
	return _u
}
