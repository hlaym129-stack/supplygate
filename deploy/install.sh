...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/hlaym129-stack/supplygate/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="hlaym129-stack/supplygate"
...
Documentation=https://github.com/hlaym129-stack/supplygate
