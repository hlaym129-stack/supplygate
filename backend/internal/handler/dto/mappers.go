...
func UserFromServiceShallow(u *service.User) *User {
	...
	return &User{
		...
		Username:                   u.Username,
		Role:                       u.Role,
		HasSupplierAccess:          u.HasSupplierAccess,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		SupplierTestedAt:              a.SupplierTestedAt,
		SupplierTestedModels:          a.SupplierTestedModels,
		SupplierEditRequestStatus:     a.SupplierEditRequestStatus,
		SupplierEditRequestReason:     a.SupplierEditRequestReason,
		SupplierEditRequestReviewNote: a.SupplierEditRequestReviewNote,
		SupplierEditRequestedAt:       a.SupplierEditRequestedAt,
		SupplierEditRequestReviewedAt: a.SupplierEditRequestReviewedAt,
		SupplierEditRequestReviewedBy: a.SupplierEditRequestReviewedBy,
...
func AccountFromService(a *service.Account) *Account {
	...
	out.Supplier = SupplierProfileFromService(a.Supplier)
...
func SupplierProfileFromService(profile *service.SupplierProfile) any {
	if profile == nil {
		return nil
	}
...
func PricingIntervalFromService(iv service.PricingInterval) PricingInterval {
...
func ChannelModelPricingFromService(p *service.ChannelModelPricing) ChannelModelPricing {
	if p == nil {
	...
	intervals := make([]PricingInterval, 0, len(p.Intervals))
	for i := range p.Intervals {
		intervals = append(intervals, PricingIntervalFromService(p.Intervals[i]))
	}
	return ChannelModelPricing{
		ID:               p.ID,
		Platform:         p.Platform,
...
func SupplierAccountPricingRevisionFromService(revision *service.SupplierAccountPricingRevision) *SupplierAccountPricingRevision {
	if revision == nil {
		return nil
	}
	pricing := make([]ChannelModelPricing, 0, len(revision.Pricing))
	for i := range revision.Pricing {
		pricing = append(pricing, ChannelModelPricingFromService(&revision.Pricing[i]))
	}
	return &SupplierAccountPricingRevision{
		...
		Pricing:      pricing,
		SubmitNote:   revision.SubmitNote,
