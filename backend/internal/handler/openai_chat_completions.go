...
// resolveRawCCUpstreamEndpoint returns the actual upstream endpoint for OpenAI
// Chat Completions requests. APIKey accounts whose upstream was probed as not
// supporting Responses are forwarded directly to /v1/chat/completions.
