...
const (
	SupplierStatusPending  = domain.SupplierStatusPending
	SupplierStatusApproved = domain.SupplierStatusApproved
	SupplierStatusRejected = domain.SupplierStatusRejected
)

// Account ownership and approval constants
const (
	AccountOwnerTypePlatform = domain.AccountOwnerTypePlatform
	AccountOwnerTypeSupplier = domain.AccountOwnerTypeSupplier

	AccountApprovalStatusPending  = domain.AccountApprovalStatusPending
	AccountApprovalStatusApproved = domain.AccountApprovalStatusApproved
	AccountApprovalStatusRejected = domain.AccountApprovalStatusRejected
	AccountApprovalStatusReturned = domain.AccountApprovalStatusReturned
)
