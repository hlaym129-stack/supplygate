...
func init() {
	...
	// accountDescOwnerType is the schema descriptor for owner_type field.
	accountDescOwnerType := accountFields[12].Descriptor()
	// account.DefaultOwnerType holds the default value on creation for the owner_type field.
	account.DefaultOwnerType = accountDescOwnerType.Default.(string)
	// account.OwnerTypeValidator is a validator for the "owner_type" field. It is called by the builders before save.
	account.OwnerTypeValidator = accountDescOwnerType.Validators[0].(func(string) error)
	// accountDescApprovalStatus is the schema descriptor for approval_status field.
	accountDescApprovalStatus := accountFields[14].Descriptor()
	// account.DefaultApprovalStatus holds the default value on creation for the approval_status field.
	account.DefaultApprovalStatus = accountDescApprovalStatus.Default.(string)
	// account.ApprovalStatusValidator is a validator for the "approval_status" field. It is called by the builders before save.
	account.ApprovalStatusValidator = accountDescApprovalStatus.Validators[0].(func(string) error)
	// accountDescSupportedModels is the schema descriptor for supported_models field.
	accountDescSupportedModels := accountFields[18].Descriptor()
	// account.DefaultSupportedModels holds the default value on creation for the supported_models field.
	account.DefaultSupportedModels = accountDescSupportedModels.Default.(func() []string)
	// accountDescSupplierTestedModels is the schema descriptor for supplier_tested_models field.
	accountDescSupplierTestedModels := accountFields[20].Descriptor()
	// account.DefaultSupplierTestedModels holds the default value on creation for the supplier_tested_models field.
	account.DefaultSupplierTestedModels = accountDescSupplierTestedModels.Default.(func() []string)
	// accountDescSupplierEditRequestStatus is the schema descriptor for supplier_edit_request_status field.
	accountDescSupplierEditRequestStatus := accountFields[21].Descriptor()
	// account.SupplierEditRequestStatusValidator is a validator for the "supplier_edit_request_status" field. It is called by the builders before save.
	account.SupplierEditRequestStatusValidator = accountDescSupplierEditRequestStatus.Validators[0].(func(string) error)
	// accountDescAutoPauseOnExpired is the schema descriptor for auto_pause_on_expired field.
	accountDescAutoPauseOnExpired := accountFields[30].Descriptor()
	// account.DefaultAutoPauseOnExpired holds the default value on creation for the auto_pause_on_expired field.
	account.DefaultAutoPauseOnExpired = accountDescAutoPauseOnExpired.Default.(bool)
	// accountDescSchedulable is the schema descriptor for schedulable field.
	accountDescSchedulable := accountFields[31].Descriptor()
	// account.DefaultSchedulable holds the default value on creation for the schedulable field.
	account.DefaultSchedulable = accountDescSchedulable.Default.(bool)
	// accountDescSessionWindowStatus is the schema descriptor for session_window_status field.
	accountDescSessionWindowStatus := accountFields[39].Descriptor()
	...
	supplierprofileFields := schema.SupplierProfile{}.Fields()
	_ = supplierprofileFields
	// supplierprofileDescCompanyName is the schema descriptor for company_name field.
	supplierprofileDescCompanyName := supplierprofileFields[1].Descriptor()
	// supplierprofile.CompanyNameValidator is a validator for the "company_name" field. It is called by the builders before save.
	supplierprofile.CompanyNameValidator = func() func(string) error {
		validators := supplierprofileDescCompanyName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// supplierprofileDescContactName is the schema descriptor for contact_name field.
	supplierprofileDescContactName := supplierprofileFields[2].Descriptor()
	// supplierprofile.DefaultContactName holds the default value on creation for the contact_name field.
	supplierprofile.DefaultContactName = supplierprofileDescContactName.Default.(string)
	// supplierprofile.ContactNameValidator is a validator for the "contact_name" field. It is called by the builders before save.
	supplierprofile.ContactNameValidator = supplierprofileDescContactName.Validators[0].(func(string) error)
	// supplierprofileDescContactEmail is the schema descriptor for contact_email field.
	supplierprofileDescContactEmail := supplierprofileFields[3].Descriptor()
	// supplierprofile.DefaultContactEmail holds the default value on creation for the contact_email field.
	supplierprofile.DefaultContactEmail = supplierprofileDescContactEmail.Default.(string)
	// supplierprofile.ContactEmailValidator is a validator for the "contact_email" field. It is called by the builders before save.
	supplierprofile.ContactEmailValidator = supplierprofileDescContactEmail.Validators[0].(func(string) error)
	// supplierprofileDescContactPhone is the schema descriptor for contact_phone field.
	supplierprofileDescContactPhone := supplierprofileFields[4].Descriptor()
	// supplierprofile.DefaultContactPhone holds the default value on creation for the contact_phone field.
	supplierprofile.DefaultContactPhone = supplierprofileDescContactPhone.Default.(string)
	// supplierprofile.ContactPhoneValidator is a validator for the "contact_phone" field. It is called by the builders before save.
	supplierprofile.ContactPhoneValidator = supplierprofileDescContactPhone.Validators[0].(func(string) error)
	// supplierprofileDescStatus is the schema descriptor for status field.
	supplierprofileDescStatus := supplierprofileFields[5].Descriptor()
	// supplierprofile.DefaultStatus holds the default value on creation for the status field.
	...
	supplierprofile.UpdateDefaultUpdatedAt = supplierprofileDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	_ = usagelogFields
	// usagelogDescAccountOwnerType is the schema descriptor for account_owner_type field.
	usagelogDescAccountOwnerType := usagelogFields[4].Descriptor()
	// usagelog.DefaultAccountOwnerType holds the default value on creation for the account_owner_type field.
	usagelog.DefaultAccountOwnerType = usagelogDescAccountOwnerType.Default.(string)
	// usagelog.AccountOwnerTypeValidator is a validator for the "account_owner_type" field. It is called by the builders before save.
	usagelog.AccountOwnerTypeValidator = usagelogDescAccountOwnerType.Validators[0].(func(string) error)
