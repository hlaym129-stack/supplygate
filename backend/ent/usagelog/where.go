...
// AccountOwnerType applies equality check predicate on the "account_owner_type" field. It's identical to AccountOwnerTypeEQ.
func AccountOwnerType(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldAccountOwnerType, v))
}
...
// AccountOwnerTypeEQ applies the EQ predicate on the "account_owner_type" field.
func AccountOwnerTypeEQ(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEQ(FieldAccountOwnerType, v))
}

// AccountOwnerTypeNEQ applies the NEQ predicate on the "account_owner_type" field.
func AccountOwnerTypeNEQ(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldNEQ(FieldAccountOwnerType, v))
}

// AccountOwnerTypeIn applies the In predicate on the "account_owner_type" field.
func AccountOwnerTypeIn(vs ...string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldIn(FieldAccountOwnerType, vs...))
}

// AccountOwnerTypeNotIn applies the NotIn predicate on the "account_owner_type" field.
func AccountOwnerTypeNotIn(vs ...string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldNotIn(FieldAccountOwnerType, vs...))
}

// AccountOwnerTypeGT applies the GT predicate on the "account_owner_type" field.
func AccountOwnerTypeGT(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldGT(FieldAccountOwnerType, v))
}

// AccountOwnerTypeGTE applies the GTE predicate on the "account_owner_type" field.
func AccountOwnerTypeGTE(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldGTE(FieldAccountOwnerType, v))
}

// AccountOwnerTypeLT applies the LT predicate on the "account_owner_type" field.
func AccountOwnerTypeLT(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldLT(FieldAccountOwnerType, v))
}

// AccountOwnerTypeLTE applies the LTE predicate on the "account_owner_type" field.
func AccountOwnerTypeLTE(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldLTE(FieldAccountOwnerType, v))
}

// AccountOwnerTypeContains applies the Contains predicate on the "account_owner_type" field.
func AccountOwnerTypeContains(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldContains(FieldAccountOwnerType, v))
}

// AccountOwnerTypeHasPrefix applies the HasPrefix predicate on the "account_owner_type" field.
func AccountOwnerTypeHasPrefix(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldHasPrefix(FieldAccountOwnerType, v))
}

// AccountOwnerTypeHasSuffix applies the HasSuffix predicate on the "account_owner_type" field.
func AccountOwnerTypeHasSuffix(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldHasSuffix(FieldAccountOwnerType, v))
}

// AccountOwnerTypeEqualFold applies the EqualFold predicate on the "account_owner_type" field.
func AccountOwnerTypeEqualFold(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldEqualFold(FieldAccountOwnerType, v))
}

// AccountOwnerTypeContainsFold applies the ContainsFold predicate on the "account_owner_type" field.
func AccountOwnerTypeContainsFold(v string) predicate.UsageLog {
	return predicate.UsageLog(sql.FieldContainsFold(FieldAccountOwnerType, v))
}
...
func HasSupplier() predicate.UsageLog {
	return predicate.UsageLog(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSupplierWith(preds ...predicate.SupplierProfile) predicate.UsageLog {
	return predicate.UsageLog(func(s *sql.Selector) {
