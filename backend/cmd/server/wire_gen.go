...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authHandler := handler.NewAuthHandler(configConfig, authService, userService, nil, settingService, promoService, redeemService, totpService)
	userHandler := handler.NewUserHandler(userService, nil, authService, emailService, emailCache, affiliateService)
	...
	supplierRepository := repository.NewSupplierRepository(client, db)
	channelService := service.NewChannelService(channelRepository, groupRepository, accountRepository, supplierRepository, apiKeyAuthCacheInvalidator, pricingService)
	...
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, balanceNotifyService, supplierRepository)
	openAITokenProvider := service.ProvideOpenAITokenProvider(accountRepository, geminiTokenCache, openAIOAuthService, oAuthRefreshAPI)
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, supplierRepository)
	...
	supplierService := service.NewSupplierService(supplierRepository, accountRepository, groupRepository, proxyRepository, userService, accountTestService, billingService)
	authHandler = handler.NewAuthHandler(configConfig, authService, userService, supplierService, settingService, promoService, redeemService, totpService)
	userHandler = handler.NewUserHandler(userService, supplierService, authService, emailService, emailCache, affiliateService)
	supplierHandler := admin.NewSupplierHandler(supplierService)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler, supplierHandler)
	...
	supplierMarketplaceService := service.NewSupplierMarketplaceService(accountRepository, supplierRepository, groupRepository, userSubscriptionRepository, subscriptionService)
	supplierMarketplaceHandler := handler.NewSupplierMarketplaceHandler(supplierMarketplaceService)
	handlerSupplierHandler := handler.NewSupplierHandler(supplierService)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, supplierMarketplaceHandler, handlerSupplierHandler, supplierService, idempotencyCoordinator, idempotencyCleanupService)
