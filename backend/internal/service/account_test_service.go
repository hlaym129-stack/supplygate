...
// TestAccountConnectionWithAccount tests a not-yet-persisted account. It is used
// by supplier pre-submit validation and deliberately avoids repository writes.
