...
type Account struct {
	...
	// SupplierTestedAt holds the value of the "supplier_tested_at" field.
	SupplierTestedAt *time.Time `json:"supplier_tested_at,omitempty"`
	// SupplierTestedModels holds the value of the "supplier_tested_models" field.
	SupplierTestedModels []string `json:"supplier_tested_models,omitempty"`
	// SupplierEditRequestStatus holds the value of the "supplier_edit_request_status" field.
	SupplierEditRequestStatus *string `json:"supplier_edit_request_status,omitempty"`
	// SupplierEditRequestReason holds the value of the "supplier_edit_request_reason" field.
	SupplierEditRequestReason *string `json:"supplier_edit_request_reason,omitempty"`
	// SupplierEditRequestReviewNote holds the value of the "supplier_edit_request_review_note" field.
	SupplierEditRequestReviewNote *string `json:"supplier_edit_request_review_note,omitempty"`
	// SupplierEditRequestedAt holds the value of the "supplier_edit_requested_at" field.
	SupplierEditRequestedAt *time.Time `json:"supplier_edit_requested_at,omitempty"`
	// SupplierEditRequestReviewedAt holds the value of the "supplier_edit_request_reviewed_at" field.
	SupplierEditRequestReviewedAt *time.Time `json:"supplier_edit_request_reviewed_at,omitempty"`
	// SupplierEditRequestReviewedBy holds the value of the "supplier_edit_request_reviewed_by" field.
	SupplierEditRequestReviewedBy *int64 `json:"supplier_edit_request_reviewed_by,omitempty"`
...
// was not loaded in eager-loading, or loaded but was not found.
func (e AccountEdges) SupplierOrErr() (*SupplierProfile, error) {
	if e.Supplier != nil {
		return e.Supplier, nil
	} else if e.loadedTypes[3] {
		return nil, &NotFoundError{label: supplierprofile.Label}
	}
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case account.FieldCredentials, account.FieldExtra, account.FieldSupportedModels, account.FieldSupplierTestedModels:
			values[i] = new([]byte)
		case account.FieldAutoPauseOnExpired, account.FieldSchedulable:
			values[i] = new(sql.NullBool)
		case account.FieldRateMultiplier:
			values[i] = new(sql.NullFloat64)
		case account.FieldID, account.FieldProxyID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority, account.FieldSupplierID, account.FieldApprovedBy, account.FieldSupplierEditRequestReviewedBy:
			values[i] = new(sql.NullInt64)
		case account.FieldName, account.FieldNotes, account.FieldPlatform, account.FieldType, account.FieldStatus, account.FieldOwnerType, account.FieldApprovalStatus, account.FieldRejectReason, account.FieldSupplierEditRequestStatus, account.FieldSupplierEditRequestReason, account.FieldSupplierEditRequestReviewNote, account.FieldErrorMessage, account.FieldTempUnschedulableReason, account.FieldSessionWindowStatus:
			values[i] = new(sql.NullString)
		case account.FieldCreatedAt, account.FieldUpdatedAt, account.FieldDeletedAt, account.FieldApprovedAt, account.FieldSupplierTestedAt, account.FieldSupplierEditRequestedAt, account.FieldSupplierEditRequestReviewedAt, account.FieldLastUsedAt, account.FieldExpiresAt, account.FieldRateLimitedAt, account.FieldRateLimitResetAt, account.FieldOverloadUntil, account.FieldTempUnschedulableUntil, account.FieldSessionWindowStart, account.FieldSessionWindowEnd:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldRejectReason:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case account.FieldSupportedModels:
			if value, ok := values[i].(*[]byte); !ok {
		...
		case account.FieldSupplierTestedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_tested_at", values[i])
			} else if value.Valid {
				_m.SupplierTestedAt = new(time.Time)
				*_m.SupplierTestedAt = value.Time
			}
		case account.FieldSupplierTestedModels:
			if value, ok := values[i].(*[]byte); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_tested_models", values[i])
			} else if value != nil && len(*value) > 0 {
				if err := json.Unmarshal(*value, &_m.SupplierTestedModels); err != nil {
					return fmt.Errorf("unmarshal field supplier_tested_models: %w", err)
				}
			}
		case account.FieldSupplierEditRequestStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_edit_request_status", values[i])
			} else if value.Valid {
				_m.SupplierEditRequestStatus = new(string)
				*_m.SupplierEditRequestStatus = value.String
			}
		case account.FieldSupplierEditRequestReason:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_edit_request_reason", values[i])
			} else if value.Valid {
				_m.SupplierEditRequestReason = new(string)
				*_m.SupplierEditRequestReason = value.String
			}
		case account.FieldSupplierEditRequestReviewNote:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_edit_request_review_note", values[i])
			} else if value.Valid {
				_m.SupplierEditRequestReviewNote = new(string)
				*_m.SupplierEditRequestReviewNote = value.String
			}
		case account.FieldSupplierEditRequestedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_edit_requested_at", values[i])
			} else if value.Valid {
				_m.SupplierEditRequestedAt = new(time.Time)
				*_m.SupplierEditRequestedAt = value.Time
			}
		case account.FieldSupplierEditRequestReviewedAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_edit_request_reviewed_at", values[i])
			} else if value.Valid {
				_m.SupplierEditRequestReviewedAt = new(time.Time)
				*_m.SupplierEditRequestReviewedAt = value.Time
			}
		case account.FieldSupplierEditRequestReviewedBy:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field supplier_edit_request_reviewed_by", values[i])
			} else if value.Valid {
				_m.SupplierEditRequestReviewedBy = new(int64)
				*_m.SupplierEditRequestReviewedBy = value.Int64
			}
...
func (_m *Account) QuerySupplier() *SupplierProfileQuery {
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SupplierTestedAt; v != nil {
		builder.WriteString("supplier_tested_at=")
		builder.WriteString(v.Format(time.ANSIC))
	}
	builder.WriteString(", ")
	builder.WriteString("supplier_tested_models=")
	builder.WriteString(fmt.Sprintf("%v", _m.SupplierTestedModels))
	builder.WriteString(", ")
	if v := _m.SupplierEditRequestStatus; v != nil {
		builder.WriteString("supplier_edit_request_status=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.SupplierEditRequestReason; v != nil {
		builder.WriteString("supplier_edit_request_reason=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.SupplierEditRequestReviewNote; v != nil {
		builder.WriteString("supplier_edit_request_review_note=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := _m.SupplierEditRequestedAt; v != nil {
		builder.WriteString("supplier_edit_requested_at=")
		builder.WriteString(v.Format(time.ANSIC))
	}
	builder.WriteString(", ")
	if v := _m.SupplierEditRequestReviewedAt; v != nil {
		builder.WriteString("supplier_edit_request_reviewed_at=")
		builder.WriteString(v.Format(time.ANSIC))
	}
	builder.WriteString(", ")
	if v := _m.SupplierEditRequestReviewedBy; v != nil {
		builder.WriteString("supplier_edit_request_reviewed_by=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
