...
export interface User {
  ...
  role: 'admin' | 'supplier' | 'user' // legacy supplier role may still exist in old data; admin remains the only management role
  has_supplier_access?: boolean
  supplier_status?: 'pending' | 'approved' | 'rejected' | 'returned' | '' | null
  user_type?: 'admin' | 'regular' | 'supplier'
...
export interface Account {
  ...
  status: 'active' | 'inactive' | 'disabled' | 'error' | 'expired' | 'unused' | 'used'
  ...
  supplier_tested_at?: string | null
  supplier_tested_models?: string[]
  supplier_edit_request_status?: 'pending' | 'approved' | 'rejected' | null
  supplier_edit_request_reason?: string | null
  supplier_edit_request_review_note?: string | null
  supplier_edit_requested_at?: string | null
  supplier_edit_request_reviewed_at?: string | null
  supplier_edit_request_reviewed_by?: number | null
  supplier?: {
    id: number
    user_id: number
    company_name: string
