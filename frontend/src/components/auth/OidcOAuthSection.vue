...
import { resolveAffiliateReferralCode, storeOAuthAffiliateCode, storeOAuthSignupContext, type OAuthSignupContext } from '@/utils/oauthAffiliate'
...
function startLogin(): void {
  ...
  storeOAuthSignupContext(props.signupContext)
