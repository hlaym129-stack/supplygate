...
func (_c *UserCreate) SetSupplierProfileID(id int64) *UserCreate {
	_c.mutation.SetSupplierProfileID(id)
	return _c
}
...
func (_c *UserCreate) SetNillableSupplierProfileID(id *int64) *UserCreate {
	if id != nil {
		_c = _c.SetSupplierProfileID(*id)
	}
	return _c
}

// SetSupplierProfile sets the "supplier_profile" edge to the SupplierProfile entity.
func (_c *UserCreate) SetSupplierProfile(v *SupplierProfile) *UserCreate {
