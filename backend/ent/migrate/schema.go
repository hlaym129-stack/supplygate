...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "owner_type", Type: field.TypeString, Size: 20, Default: "platform"},
		{Name: "approval_status", Type: field.TypeString, Size: 20, Default: "approved"},
		...
		{Name: "supplier_tested_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "supplier_tested_models", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "supplier_edit_request_status", Type: field.TypeString, Nullable: true, Size: 20},
		{Name: "supplier_edit_request_reason", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "supplier_edit_request_review_note", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "supplier_edit_requested_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "supplier_edit_request_reviewed_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "supplier_edit_request_reviewed_by", Type: field.TypeInt64, Nullable: true},
	...
	AccountsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "accounts_supplier_profiles_accounts",
				Columns:    []*schema.Column{AccountsColumns[43]},
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "account_supplier_edit_request_status",
				Unique:  false,
	...
	// SupplierProfilesColumns holds the columns for the "supplier_profiles" table.
	SupplierProfilesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "company_name", Type: field.TypeString, Size: 120},
	...
	// SupplierProfilesTable holds the schema information for the "supplier_profiles" table.
	SupplierProfilesTable = &schema.Table{
		Name:       "supplier_profiles",
		Columns:    SupplierProfilesColumns,
		PrimaryKey: []*schema.Column{SupplierProfilesColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
		...
		Indexes: []*schema.Index{
			{
				Name:    "supplierprofile_status",
				Unique:  false,
				Columns: []*schema.Column{SupplierProfilesColumns[5]},
			},
			{
	...
	UsageLogsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "account_owner_type", Type: field.TypeString, Size: 20, Default: "platform"},
	...
	UsageLogsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "usage_logs_supplier_profiles_usage_logs",
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_supplier_id",
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[37]},
			},
			{
				Name:    "usagelog_account_owner_type",
				Unique:  false,
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[38], UsageLogsColumns[33]},
			},
			{
...
func init() {
	...
	AccountsTable.ForeignKeys[1].RefTable = SupplierProfilesTable
	...
	SupplierProfilesTable.ForeignKeys[0].RefTable = UsersTable
	SupplierProfilesTable.Annotation = &entsql.Annotation{
	...
	UsageLogsTable.ForeignKeys[3].RefTable = SupplierProfilesTable
