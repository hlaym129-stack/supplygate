...
func registerSupplierAdminRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	{
		suppliers.GET("", h.Admin.Supplier.ListProfiles)
		suppliers.PUT("/:id/review", h.Admin.Supplier.ReviewProfile)
	}

	supplierAccounts := admin.Group("/supplier-accounts")
	{
		supplierAccounts.GET("", h.Admin.Supplier.ListAccounts)
		supplierAccounts.POST("/:id/approve", h.Admin.Supplier.ApproveAccount)
		supplierAccounts.POST("/:id/reject", h.Admin.Supplier.RejectAccount)
		supplierAccounts.POST("/:id/return", h.Admin.Supplier.ReturnAccountForEdit)
		supplierAccounts.POST("/:id/edit-request/reject", h.Admin.Supplier.RejectAccountEditRequest)
		supplierAccounts.GET("/:id/pricing-revisions", h.Admin.Supplier.ListPricingRevisions)
	}

	supplierPricingRevisions := admin.Group("/supplier-account-pricing-revisions")
	{
