...
type UsageLog struct {
	...
	// AccountOwnerType holds the value of the "account_owner_type" field.
	AccountOwnerType string `json:"account_owner_type,omitempty"`
...
// was not loaded in eager-loading, or loaded but was not found.
func (e UsageLogEdges) SupplierOrErr() (*SupplierProfile, error) {
	if e.Supplier != nil {
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldSupplierID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldImageCount:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldAccountOwnerType, usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldAccountOwnerType:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field account_owner_type", values[i])
			} else if value.Valid {
				_m.AccountOwnerType = value.String
			}
...
// QuerySupplier queries the "supplier" edge of the UsageLog entity.
func (_m *UsageLog) QuerySupplier() *SupplierProfileQuery {
	return NewUsageLogClient(_m.config).QuerySupplier(_m)
}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("account_owner_type=")
	builder.WriteString(_m.AccountOwnerType)
	builder.WriteString(", ")
