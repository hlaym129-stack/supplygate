...
const supplierProfile = ref<RegisterRequest['supplier_profile']>()
...
onMounted(async () => {
  ...
  if (registerDataStr) {
    try {
      ...
      accountType.value = registerData.account_type === 'supplier' ? 'supplier' : 'user'
      supplierProfile.value = registerData.supplier_profile
  ...
  try {
    ...
    if (isPendingOAuthFlow()) {
      const pendingOAuthPayload = {
        ...
        ...(accountType.value === 'supplier' ? { account_type: 'supplier', supplier_profile: supplierProfile.value } : {}),
        ...oauthAffiliatePayload(affCode.value || loadAffiliateReferralCode()),
        ...(pendingAdoptionDecision.value?.adoptDisplayName !== undefined ? { adopt_display_name: pendingAdoptionDecision.value.adoptDisplayName } : {}),
        ...(pendingAdoptionDecision.value?.adoptAvatar !== undefined ? { adopt_avatar: pendingAdoptionDecision.value.adoptAvatar } : {})
      }
      ...
      await authStore.register({
        ...
        ...(accountType.value === 'supplier' ? { account_type: 'supplier' as const, supplier_profile: supplierProfile.value } : {}),
