...
const (
	...
	// FieldAccountOwnerType holds the string denoting the account_owner_type field in the database.
	FieldAccountOwnerType = "account_owner_type"
...
var (
	// DefaultAccountOwnerType holds the default value on creation for the "account_owner_type" field.
	DefaultAccountOwnerType string
	// AccountOwnerTypeValidator is a validator for the "account_owner_type" field. It is called by the builders before save.
	AccountOwnerTypeValidator func(string) error
...
// ByAccountOwnerType orders the results by the account_owner_type field.
func ByAccountOwnerType(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAccountOwnerType, opts...).ToFunc()
}
