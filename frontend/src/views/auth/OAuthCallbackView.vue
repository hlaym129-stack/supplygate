...
async function handleSubmitRegistration() {
  ...
  try {
    ...
    const payload: {
      ...
      supplier_profile?: NonNullable<ReturnType<typeof loadOAuthSignupContext>['supplier_profile']>
    } = {
    ...
    if (signupContext.account_type === 'supplier' && signupContext.supplier_profile?.company_name) {
      payload.account_type = 'supplier'
      payload.supplier_profile = signupContext.supplier_profile
    }
