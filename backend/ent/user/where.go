...
func HasSupplierProfile() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, SupplierProfileTable, SupplierProfileColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasSupplierProfileWith(preds ...predicate.SupplierProfile) predicate.User {
	return predicate.User(func(s *sql.Selector) {
