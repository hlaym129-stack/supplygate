...
const (
	AccountOwnerTypePlatform = "platform"
	AccountOwnerTypeSupplier = "supplier"

	AccountApprovalStatusPending  = "pending"
	AccountApprovalStatusApproved = "approved"
	AccountApprovalStatusRejected = "rejected"
	AccountApprovalStatusReturned = "returned"
)
