...
const (
	...
	// FieldSupplierTestedAt holds the string denoting the supplier_tested_at field in the database.
	FieldSupplierTestedAt = "supplier_tested_at"
	// FieldSupplierTestedModels holds the string denoting the supplier_tested_models field in the database.
	FieldSupplierTestedModels = "supplier_tested_models"
	// FieldSupplierEditRequestStatus holds the string denoting the supplier_edit_request_status field in the database.
	FieldSupplierEditRequestStatus = "supplier_edit_request_status"
	// FieldSupplierEditRequestReason holds the string denoting the supplier_edit_request_reason field in the database.
	FieldSupplierEditRequestReason = "supplier_edit_request_reason"
	// FieldSupplierEditRequestReviewNote holds the string denoting the supplier_edit_request_review_note field in the database.
	FieldSupplierEditRequestReviewNote = "supplier_edit_request_review_note"
	// FieldSupplierEditRequestedAt holds the string denoting the supplier_edit_requested_at field in the database.
	FieldSupplierEditRequestedAt = "supplier_edit_requested_at"
	// FieldSupplierEditRequestReviewedAt holds the string denoting the supplier_edit_request_reviewed_at field in the database.
	FieldSupplierEditRequestReviewedAt = "supplier_edit_request_reviewed_at"
	// FieldSupplierEditRequestReviewedBy holds the string denoting the supplier_edit_request_reviewed_by field in the database.
	FieldSupplierEditRequestReviewedBy = "supplier_edit_request_reviewed_by"
	...
	// SupplierInverseTable is the table name for the SupplierProfile entity.
	// It exists in this package in order to avoid circular dependency with the "supplierprofile" package.
	SupplierInverseTable = "supplier_profiles"
...
var Columns = []string{
	...
	FieldSupplierTestedAt,
	FieldSupplierTestedModels,
	FieldSupplierEditRequestStatus,
	FieldSupplierEditRequestReason,
	FieldSupplierEditRequestReviewNote,
	FieldSupplierEditRequestedAt,
	FieldSupplierEditRequestReviewedAt,
	FieldSupplierEditRequestReviewedBy,
	FieldErrorMessage,
	FieldLastUsedAt,
	FieldExpiresAt,
...
var (
	...
	DefaultSupportedModels func() []string
	// DefaultSupplierTestedModels holds the default value on creation for the "supplier_tested_models" field.
	DefaultSupplierTestedModels func() []string
	// SupplierEditRequestStatusValidator is a validator for the "supplier_edit_request_status" field. It is called by the builders before save.
	SupplierEditRequestStatusValidator func(string) error
...
// BySupplierTestedAt orders the results by the supplier_tested_at field.
func BySupplierTestedAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierTestedAt, opts...).ToFunc()
}

// BySupplierEditRequestStatus orders the results by the supplier_edit_request_status field.
func BySupplierEditRequestStatus(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierEditRequestStatus, opts...).ToFunc()
}

// BySupplierEditRequestReason orders the results by the supplier_edit_request_reason field.
func BySupplierEditRequestReason(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierEditRequestReason, opts...).ToFunc()
}

// BySupplierEditRequestReviewNote orders the results by the supplier_edit_request_review_note field.
func BySupplierEditRequestReviewNote(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierEditRequestReviewNote, opts...).ToFunc()
}

// BySupplierEditRequestedAt orders the results by the supplier_edit_requested_at field.
func BySupplierEditRequestedAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierEditRequestedAt, opts...).ToFunc()
}

// BySupplierEditRequestReviewedAt orders the results by the supplier_edit_request_reviewed_at field.
func BySupplierEditRequestReviewedAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierEditRequestReviewedAt, opts...).ToFunc()
}

// BySupplierEditRequestReviewedBy orders the results by the supplier_edit_request_reviewed_by field.
func BySupplierEditRequestReviewedBy(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSupplierEditRequestReviewedBy, opts...).ToFunc()
}
