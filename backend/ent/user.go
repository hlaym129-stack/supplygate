...
func (e UserEdges) SupplierProfileOrErr() (*SupplierProfile, error) {
...
// QuerySupplierProfile queries the "supplier_profile" edge of the User entity.
func (_m *User) QuerySupplierProfile() *SupplierProfileQuery {
	return NewUserClient(_m.config).QuerySupplierProfile(_m)
}
