...
// SetAccountOwnerType sets the "account_owner_type" field.
func (_c *UsageLogCreate) SetAccountOwnerType(v string) *UsageLogCreate {
	_c.mutation.SetAccountOwnerType(v)
	return _c
}

// SetNillableAccountOwnerType sets the "account_owner_type" field if the given value is not nil.
func (_c *UsageLogCreate) SetNillableAccountOwnerType(v *string) *UsageLogCreate {
	if v != nil {
		_c.SetAccountOwnerType(*v)
	}
	return _c
}
...
func (_c *UsageLogCreate) SetSupplier(v *SupplierProfile) *UsageLogCreate {
...
func (_c *UsageLogCreate) defaults() {
	if _, ok := _c.mutation.AccountOwnerType(); !ok {
		v := usagelog.DefaultAccountOwnerType
		_c.mutation.SetAccountOwnerType(v)
	}
...
func (_c *UsageLogCreate) check() error {
	...
	if _, ok := _c.mutation.AccountOwnerType(); !ok {
		return &ValidationError{Name: "account_owner_type", err: errors.New(`ent: missing required field "UsageLog.account_owner_type"`)}
	}
	if v, ok := _c.mutation.AccountOwnerType(); ok {
		if err := usagelog.AccountOwnerTypeValidator(v); err != nil {
			return &ValidationError{Name: "account_owner_type", err: fmt.Errorf(`ent: validator failed for field "UsageLog.account_owner_type": %w`, err)}
		}
	}
...
func (_c *UsageLogCreate) createSpec() (*UsageLog, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AccountOwnerType(); ok {
		_spec.SetField(usagelog.FieldAccountOwnerType, field.TypeString, value)
		_node.AccountOwnerType = value
	}
	...
	if nodes := _c.mutation.SupplierIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   usagelog.SupplierTable,
			Columns: []string{usagelog.SupplierColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetAccountOwnerType sets the "account_owner_type" field.
func (u *UsageLogUpsert) SetAccountOwnerType(v string) *UsageLogUpsert {
	u.Set(usagelog.FieldAccountOwnerType, v)
	return u
}

// UpdateAccountOwnerType sets the "account_owner_type" field to the value that was provided on create.
func (u *UsageLogUpsert) UpdateAccountOwnerType() *UsageLogUpsert {
	u.SetExcluded(usagelog.FieldAccountOwnerType)
	return u
}
...
// SetAccountOwnerType sets the "account_owner_type" field.
func (u *UsageLogUpsertOne) SetAccountOwnerType(v string) *UsageLogUpsertOne {
	return u.Update(func(s *UsageLogUpsert) {
		s.SetAccountOwnerType(v)
	})
}

// UpdateAccountOwnerType sets the "account_owner_type" field to the value that was provided on create.
func (u *UsageLogUpsertOne) UpdateAccountOwnerType() *UsageLogUpsertOne {
	return u.Update(func(s *UsageLogUpsert) {
		s.UpdateAccountOwnerType()
	})
}
...
// SetAccountOwnerType sets the "account_owner_type" field.
func (u *UsageLogUpsertBulk) SetAccountOwnerType(v string) *UsageLogUpsertBulk {
	return u.Update(func(s *UsageLogUpsert) {
		s.SetAccountOwnerType(v)
	})
}
...
// UpdateAccountOwnerType sets the "account_owner_type" field to the value that was provided on create.
func (u *UsageLogUpsertBulk) UpdateAccountOwnerType() *UsageLogUpsertBulk {
	return u.Update(func(s *UsageLogUpsert) {
		s.UpdateAccountOwnerType()
	})
}
