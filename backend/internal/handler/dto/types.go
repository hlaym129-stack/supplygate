...
type User struct {
	...
	HasSupplierAccess bool       `json:"has_supplier_access"`
...
type Group struct {
	...
	SupplierProfileID *int64 `json:"supplier_profile_id"`
...
type Account struct {
	...
	SupplierTestedAt              *time.Time     `json:"supplier_tested_at"`
	SupplierTestedModels          []string       `json:"supplier_tested_models"`
	SupplierEditRequestStatus     string         `json:"supplier_edit_request_status"`
	SupplierEditRequestReason     string         `json:"supplier_edit_request_reason"`
	SupplierEditRequestReviewNote string         `json:"supplier_edit_request_review_note"`
	SupplierEditRequestedAt       *time.Time     `json:"supplier_edit_requested_at"`
	SupplierEditRequestReviewedAt *time.Time     `json:"supplier_edit_request_reviewed_at"`
	SupplierEditRequestReviewedBy *int64         `json:"supplier_edit_request_reviewed_by"`
